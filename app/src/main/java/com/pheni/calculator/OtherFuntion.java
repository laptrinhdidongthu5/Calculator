...
import com.pheni.calculator.Operation1;
...
public class OtherFuntion {
    ...
    public double KyPhapBaLanNguoc(String toanHang)
    {
        ...
        {
            String tinhtoantam="";
            tinhtoantam+=NganXep1.peek().charAt(3);
            tinhtoantam+=NganXep1.peek().charAt(4);
            Operation1 tinhToan=new Operation1(Double.parseDouble(tinhtoantam));
            b=tinhToan.TinhSin();
            NganXep1.push(String.valueOf(b));
        }
        else
        {
            if(NganXep1.peek().charAt(0)=='c')
